  ...
  //连接测试网网络
  const provider = new ethers.providers.JsonRpcProvider('https://ropsten.infura.io/v3/ea105d55c4394f4fb7b58d29c877e797')



  //创建钱包
  privatekey = "abb057071c75065d6d60e778ff4eaefa3087d2eba09ba0233c1e996bfe5f702c";
  ...
  const Creat_Strategy = async () => {
    let balance =  await daiContractInstance.balanceOf(wallet.address); 
    console.log(balance.toString());
    let daiapprove = await daiContractInstance.approve(Out_ropsten_address,"5000000000000000000");
    ...
    // const dai_balance = await daiContractInstance.balanceOf(Out_ropsten_address)
